...
class TopCategoryAdapter(context: Context) :
        BaseRecyclerViewAdapter<CategoryInfo, TopCategoryAdapter.ViewHolder>(context) {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.topCategoryNameTv.text = dataList[position].categoryName
        holder.itemView.topCategoryNameTv.isSelected = dataList[position].isSelected
    }
